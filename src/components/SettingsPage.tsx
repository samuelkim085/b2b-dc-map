          ...
          <div className="settings-row">
            <label className="settings-checkbox-label">
              <input
                ...
                onChange={(e) => onChange({ showAlaska: e.target.checked })}
              />
              Alaska
            </label>
          </div>
          <div className="settings-row">
            <label className="settings-checkbox-label">
              <input
                ...
                onChange={(e) => onChange({ showHawaii: e.target.checked })}
              />
              Hawaii
            </label>
          </div>
          <div className="settings-row">
            <label className="settings-checkbox-label">
              <input
                ...
                onChange={(e) =>
                  onChange({ showPanamaExtent: e.target.checked })
                }
              />
              Extend map to Panama
            </label>
          </div>
          <div className="settings-row">
            <label className="settings-label" htmlFor="projection-center-lon">
            ...
            <div className="settings-slider-row">
              <input
                ...
                onChange={(e) =>
                  onChange({ mapCenterLon: parseInt(e.target.value, 10) })
                }
              />
              <span className="settings-value">{settings.mapCenterLon}</span>
            </div>
          </div>
          <div className="settings-row">
            <label className="settings-label" htmlFor="projection-center-lat">
            ...
            <div className="settings-slider-row">
              <input
                ...
                disabled={!settings.showPanamaExtent}
                onChange={(e) =>
                  onChange({ mapCenterLat: parseInt(e.target.value, 10) })
                }
              />
              <span className="settings-value">{settings.mapCenterLat}</span>
            </div>
          </div>
          <div className="settings-row">
            <label className="settings-label" htmlFor="projection-scale">
              Projection scale
            </label>
            <div className="settings-slider-row">
              <input
                ...
                disabled={!settings.showPanamaExtent}
                onChange={(e) =>
                  onChange({ mapScale: parseInt(e.target.value, 10) })
                }
              />
              <span className="settings-value">{settings.mapScale}</span>
            </div>
          </div>
          <div className="settings-row settings-muted-row">
            Canada — coming soon
          </div>
          <div className="settings-row settings-muted-row">
          ...
          <div className="settings-row">
            <label className="settings-checkbox-label">
              <input
                ...
                onChange={(e) => onChange({ showDcMarkers: e.target.checked })}
              />
              Show DC markers
            </label>
          </div>
          <div className="settings-row">
            <label className="settings-checkbox-label">
              <input
                ...
                onChange={(e) => onChange({ showZipDots: e.target.checked })}
              />
              Show zip dots
            </label>
          </div>
          ...
          <div className="settings-row">
            ...
            <div className="settings-slider-row">
              <input
                ...
                onChange={(e) =>
                  onChange({ dcLogoScale: parseFloat(e.target.value) })
                }
              />
              <span className="settings-value">
                {settings.dcLogoScale.toFixed(1)}×
              </span>
            </div>
          </div>
          <div className="settings-row">
            ...
            <div className="settings-slider-row">
              <input
                ...
                onChange={(e) =>
                  onChange({ logoPadding: parseInt(e.target.value, 10) })
                }
              />
          ...
          <div className="settings-row">
            ...
            <div className="settings-slider-row">
              <input
                ...
                onChange={(e) =>
                  onChange({ zipDotSize: parseInt(e.target.value, 10) })
                }
              />
        ...
        <section className="settings-section">
          ...
          <div className="settings-row">
            ...
            <input
              ...
              onChange={(e) =>
                onChange({
                  defaultMinVolume: parseInt(e.target.value, 10) || 0,
                })
              }
            />
          </div>
